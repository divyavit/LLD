...
public class RoomManagementTest {
    ...
    public void setup() {
        ...
        this.bookManagerService = new BookManagerService(availabilityService);
    ...
    public void testBooking() {
        ...
        // create a building
        addBuilding.apply("building1");
        addBuilding.apply("building2");
        
        // create 2 floors building 1
        addFloor.apply(Pair.of("building1", 1));
        addFloor.apply(Pair.of("building1", 2));

        // create 1 floor building 2
        addFloor.apply(Pair.of("building2", 1));
        ...
        val r = addRoom.apply(Pair.of("roomb2_1", Pair.of("building2", 1)));

        val rooms = searchRoomService.listRooms(user1.getId(), "building1");
        Assertions.assertEquals(rooms.size(), 3);

        val roomsb2 = searchRoomService.listRooms(user1.getId(), "building2");
        Assertions.assertEquals(roomsb2.size(), 1);
